...
//        list.add(map);
    ...
    <body id="reportsPage">
            ...
            <div class="container h-100">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mx-auto h-100">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="StaffManageOrderServlet?mode=viewOrder">
        ...
        <div class="container mt-5">
                        ...
                        <form>
                            <div class="search-wrapper">
                                ...
                                <div class="input-holder">
                                    <form action="StaffManageOrderServlet" method="post">
            ...
            <form action="StaffManageOrderServlet?mode=generateChart" method="POST">
...
//                                    {
////                                    String str = "StaffManageOrderServlet?mode=viewOrderDetail&orderID=" + orderID;
